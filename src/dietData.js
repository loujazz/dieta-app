...
// Trascritta dalla scheda PDF "Luigi Parisi (Si sport)" del 16/07/2026.
export const sportDiet = {
  titolo: "Dieta Luigi Parisi (Giorno Sport)",
  dataStampa: "16/07/2026",
  pasti: [
    {
      id: "colazione", nome: "Colazione", icon: "Coffee",
      blocchi: [
        ...
        { principale: { nome: "Fiocchi di mais – Cornflakes", g: 70 },
          alternative: [
            { nome: "Muesli", g: 70, noteRef: 1 }
          ]},
        { principale: { nome: "Pane integrale", g: 60, noteRef: 2 },
          alternative: [
            { nome: "Pane multicereali", g: 60 },
            { nome: "Pane in cassetta integrale", g: 50, noteRef: 3 },
            { nome: "Pane in cassetta ai cereali misti", g: 50 }
          ]},
        { principale: { nome: "Crema 100% frutta secca (nocciole, mandorle..)", g: 20, noteRef: 4 },
          alternative: [
            { nome: "Burro d'arachidi 100%", g: 20 },
            { nome: "Ricotta di mucca", g: 80 },
            { nome: "Philadelphia protein", g: 100 },
            { nome: "Mandorle", g: 20, noteRef: 5 },
            { nome: "Noci", g: 20, noteRef: 6 },
            { nome: "Nocciole", g: 20, noteRef: 7 },
            { nome: "Cioccolato fondente (>70% cacao)", g: 20 }
          ]},
        { principale: { nome: "Marmellata 100% frutta", g: 20, noteRef: 8 },
          alternative: [] }
      ]
    },
    {
      id: "spuntino-matt", nome: "Spuntino", icon: "Apple",
      blocchi: [
        { principale: { nome: "Crackers integrali", g: 40, noteRef: 9 },
          alternative: [
            { nome: "Crackers non salati in superficie", g: 40 }
          ]},
        { principale: { nome: "Mandorle", g: 20 },
      ...
      blocchi: [
        { principale: { nome: "Pasta integrale", g: 90 },
          alternative: [
            ...
            { nome: "Riso", g: 80 }, { nome: "Cous cous", g: 80 },
            { nome: "Cereali (media)", g: 90 },
            { nome: "Pane integrale", g: 120, noteRef: 10 }, { nome: "Pane multicereali", g: 120 }
          ]},
        { principale: { nome: "Pomodori – passata", g: 80 },
          alternative: [{ nome: "Sugo alle verdure", g: 80 }]},
        { principale: { nome: "Legumi secchi", g: 60, frequenza: "3/7" },
          alternative: [
            ...
            { nome: "Prosciutto cotto", g: 70 }, { nome: "Prosciutto crudo", g: 70 },
            { nome: "Bresaola", g: 100 }, { nome: "Petto di pollo, affettato", g: 120 },
            { nome: "Uovo di gallina – intero", g: 120, frequenza: "1/7", noteRef: 11 },
            { nome: "Tonno sott'olio sgocciolato", g: 70, frequenza: "1/7" }
          ]},
        { principale: { nome: "Pane integrale", g: 60, noteRef: 12 },
          alternative: [{ nome: "Pane multicereali", g: 60 }]},
        { principale: { nome: "Verdure (media)", g: 150 }, alternative: []},
        { principale: { nome: "Olio di oliva extravergine", g: 20, noteRef: 13 }, alternative: []}
      ]
    },
    {
      id: "merenda", nome: "Merenda", icon: "Cookie",
      blocchi: [
        { principale: { nome: "Crackers integrali", g: 40, noteRef: 14 },
          alternative: [
            { nome: "Crackers non salati in superficie", g: 40 },
            { nome: "Pane integrale", g: 60 }, { nome: "Pane multicereali", g: 60 },
            { nome: "Pane in cassetta integrale", g: 50 }, { nome: "Pane in cassetta ai cereali misti", g: 50 }
        ...
        { principale: { nome: "Yogurt greco 0% grassi, bianco", g: 150, noteRef: 15 },
          alternative: [
            { nome: "Parmigiano", g: 30 }, { nome: "Proteine Whey 100%", g: 30, noteRef: 16 }
          ]},
        { principale: { nome: "Frutta fresca (media)", g: 150 },
          alternative: [{ nome: "Succo 100% frutta", g: 150 }]}
      ]
      ...
      blocchi: [
        { principale: { nome: "Formaggi freschi (media)", g: 100, frequenza: "2/7" },
          alternative: [
            ...
            { nome: "Pollo – petto", g: 200, frequenza: "2/7" }, { nome: "Tacchino – petto", g: 200 },
            { nome: "Vitello – filetto", g: 200 },
            { nome: "Uovo di gallina – intero", g: 180, frequenza: "1/7", noteRef: 17 }
          ]},
        { principale: { nome: "Pane integrale", g: 120, noteRef: 18 },
          alternative: [{ nome: "Pane multicereali", g: 120 }, { nome: "Patate", g: 350 }]},
        { principale: { nome: "Verdure (media)", g: 150 }, alternative: []},
        { principale: { nome: "Olio di oliva extravergine", g: 10, noteRef: 19 }, alternative: []}
      ]
    },
    {
      id: "spuntino-serale", nome: "Serale", icon: "Star",
      blocchi: [
        { principale: { nome: "Frutta fresca (media)", g: 150 }, alternative: []}
      ]
    }
  ],
  note: [
    ...
    { id: 2,  testo: "2 fette." },
    { id: 3,  testo: "2 fette." },
    { id: 4,  testo: "Le creme e i formaggi si intendono da spalmare sul pane con la marmellata in superficie." },
    { id: 5,  testo: "16-18 mandorle." },
    { id: 6,  testo: "4 noci." },
    { id: 7,  testo: "16-18 nocciole." },
    { id: 8,  testo: "2 cucchiaini." },
    { id: 9,  testo: "1 pacchetto." },
    { id: 10, testo: "4 fette." },
    { id: 11, testo: "2 uova." },
    { id: 12, testo: "2 fette." },
    { id: 13, testo: "2 cucchiai o 4 cucchiaini." },
    { id: 14, testo: "Pre-workout." },
    { id: 15, testo: "Post-workout. È possibile aggiungere un cucchiaino di miele allo yogurt." },
    { id: 16, testo: "1 misurino. Per esempio: Star Whey Named Sport, Hydrogold 90 Keforma, IsoWhey Proaction, 100% Isolate Zero Enervit." },
    { id: 17, testo: "3 uova oppure 2 uova + 150g di albume / 20g di parmigiano grattugiato." },
    { id: 18, testo: "4 fette." },
    { id: 19, testo: "1 cucchiaio o 2 cucchiaini." }
  ]
};
